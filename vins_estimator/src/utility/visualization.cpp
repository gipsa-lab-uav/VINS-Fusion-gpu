...
void pubCameraPose(const Estimator &estimator, const std_msgs::Header &header)
{
    ...
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        if(STEREO)
        {
            ...
            odometry_r.header.frame_id = odom_frame_id;
            ...
            if(PUB_RECTIFY)
            {
                ...
                R_pose_l.header.frame_id = odom_frame_id;
                R_pose_r.header.frame_id = odom_frame_id;
...
void pubTF(const Estimator &estimator, const std_msgs::Header &header)
{
    ...
    br.sendTransform(tf::StampedTransform(transform, header.stamp, odom_frame_id, body_frame_id));
    ...
    transform.setRotation(q);
    br.sendTransform(tf::StampedTransform(transform, header.stamp, body_frame_id, "camera"));
